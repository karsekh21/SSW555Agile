...
from GedReader import US01, US02, US03, US04, US05, US06, US07, US08, US09, US10,US12,US14,US15,US16,US17,US18,US19,US20,US21,US22,US23,US24,US25,calculate_age,US29,US30,US31,US34,US35,US36,US38,US39
...
class TestUserStories(unittest.TestCase):
    ...
    def test_US09(self):
        self.assertEqual(US09({'ID':'I1','BIRT':'2 DEC 2002','FAMC':['F1']},{'ID':'F1','HUSB':'I2','WIFE':'I3'},[{'ID':'F1'}]),False)
    def test_US10(self):
        listOfPpl = []
        ...
        self.assertEqual(US10(jon,{'ID':'F23','MARR':'4 OCT 2005','DIV':'5 DEC 2006', 'HUSB':'I26', 'WIFE':'I07'}, listOfPpl), True)
    def test_US12(self):
        listOfPpl=[]
    ...
    def test_US17(self):
        self.assertFalse(US17([{'ID':'I1','FAMC':['F1'],'FAMS':['F1']},{'ID':'I2','FAMS':['F1']}],{'ID':'F1','HUSB':'I1','WIFE':'I2'},[{'ID':'F1'}]))
    def test_US18(self):
    ...
    def test_US21(self):
        self.assertEqual(US21({'ID':'I1','SEX':'M', 'FAMS':'F1'},{'ID':'F1', 'WIFE':'I1', 'HUSB':'I2'}),False)
    def test_US22(self):
        self.assertEqual(US22({'ID':'I1'},['I1','I1']),False)
    def test_US23(self):
    ...
    def test_US27(self):
        self.assertEqual(calculate_age(datetime.strptime('20 FEB 1998','%d %b %Y'),date.today()),20)
    def test_US29(self):
        listOfPpl = []
        deceased = []
        joe = {'BIRT': '15 JUL 1600', 'FAMS': ['F23','F100'], 'NAME': 'Joe /Smith/', 'ALIVE': False, 'AGE': 'N/A', 'FAMC': 'N/A', 'ID': 'I01', 'DEAT': '31 DEC 1900', 'SEX': 'M'}
